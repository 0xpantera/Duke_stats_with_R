...
bandit_posterior(data = data.frame(machine=2L, outcome="W"))
```
...
```{r}
data1 <- data.frame(machine = c(1L, 1L, 2L, 2L, 2L), outcome = c('W', 'W', 'W', 'W', 'L'))
...
```{r}
data1 <- data.frame(machine = c(2L, 2L, 2L, 1L, 1L), outcome = c('W', 'W', 'L', 'W', 'W'))
bandit_posterior(data1)
```
...
data2 <- data.frame(machine = c(rep(2L, 3)), outcome = c('W','W', 'L'))
bandit_posterior(data1) %>% bandit_posterior(data2, prior = .)
```
...
```{r}
data = data.frame(machine = c(1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 1L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L, 2L), outcome = c("W", "W", "L", "W", "L", "L", "W", "L", "L", "L", "W", "L", "L", "L", "W", "W", "W", "W", "W", "L", "W", "L", "W", "W", "W", "W", "L", "W", "L", "W"))
...
```{r}
data50 = data.frame(machine = c(1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L, 1L, 2L), outcome = c("L", "W", "L", "L", "L", "L", "L", "L", "L", "W", "L", "L", "W", "L", "L", "L", "L", "L", "L", "L", "L", "W", "L", "W", "L", "W", "L", "L", "L", "W", "L", "L", "L", "W", "W", "W", "W", "W", "L", "L", "W", "L", "L", "W", "L", "W", "W", "L", "L", "L"))

bandit_posterior(data50[1:10,]) %>% 
    bandit_posterior(data50[11:20,], prior = .) %>%
    bandit_posterior(data50[21:30,], prior = .) %>%
    bandit_posterior(data50[31:40,], prior = .) %>%
    bandit_posterior(data50[41:50,], prior = .)
```
